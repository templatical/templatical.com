...
const classes = computed(() =>
    cn(
        'group relative inline-flex min-h-11 max-w-full gap-x-3 gap-y-1.5 overflow-hidden rounded-md px-3.5 py-2 text-sm/6 max-sm:flex-col sm:items-center sm:rounded-full sm:px-3 sm:py-1',
