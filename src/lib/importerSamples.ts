...
export const IMPORTER_SAMPLES: Readonly<Record<string, ImporterSample>> = {
    ...
    "unlayer": {
        ...
        warning: "Row with 4 columns was flattened to a single column. Unlayer supports arbitrary columns, but Templatical supports up to 3.",
    },
    "stripo": {
        slug: "stripo",
    ...
    "topol": {
        ...
        warning: "Dropped the document line-height (1.5) — Templatical has no document-level line-height setting.",
    },
    "chamaileon": {
        slug: "chamaileon",
